    ...
    for ii=1:numexperiments;
        ...
        for j=1:length(SylsUnique)
            ...
            for day=1:NumDays
                ...
                % ---- OUTPUT
                SeqDepPitch_AcrossBirds.birds{i}.experiment{ii}.Data_PlotLearning.AllDays_PlotLearning.DataMatrix_MUSC.(syl).FFvals_DevFromBase_WithinTimeWindow{day}=ffvals_minusBase_new;
