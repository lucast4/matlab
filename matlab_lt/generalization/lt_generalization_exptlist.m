...
% NOTE TO SELF
% EXPTS that should look into whether some same-type are actually labeled
% diff type
% wh44 LM2
% wh6 LM2
% or74 LM2
% pu69 RALM1
% bk34bk68 - removed two syls as are very noisy.
...
%     MotifsToExtract = {'njjj(b)', 'njjjb(b)', 'klj(b)', 'kljb(b)', 'kljbbg(a)'};
    MotifsToExtract = {'njjjb(b)', 'klj(b)', 'kljb(b)'};
    MotifsToRename = {};
    TargSyl = {'njjjb(b)'};
    TargLearnDirs = [-1];
    % --- dates
    Date_WNon =  '24Jan2016-2330';
    Date_SwitchTimes = {};
    
elseif strcmp(birdname, 'wh25pk77') & strcmp(exptname, 'SeqDepPitchLMAN')
