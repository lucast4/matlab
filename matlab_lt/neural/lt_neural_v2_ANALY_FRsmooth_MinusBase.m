            ...
            for nn=1:maxneur
                ...
                for j=indsthis'
                    ...
                    if ss==1 & nbasetime_ignoreswitch1==1
                        ...
                        [FRmeanAll, FRsemAll, tbin, frlo, frhi, PitchmeanAll] ...
                            = fn_subtractbase(OUTDAT, j, prctile_divs, usepercent, []);
                    else
                        [FRmeanAll, FRsemAll, tbin, frlo, frhi, PitchmeanAll] ...
                            = fn_subtractbase(OUTDAT, j, prctile_divs, usepercent, nbasetime);
                    end
...
function [FRmeanAll, FRsemAll, tbin, frlo, frhi, PitchmeanAll] = fn_subtractbase(OUTDAT, j, prctile_divs, usepercent, nbasetime)
% ===== PARAMS
