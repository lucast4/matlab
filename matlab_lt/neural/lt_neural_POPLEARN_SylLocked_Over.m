...
% ==== DURING WN
DATSTRUCT.LFP_dat_WN = {};
DATSTRUCT.FRsmooth_dat_WN = {};
...
[frsmall, x] = lt_neural_POPLEARN_SylLocked_Over_sub2(neurlist, DAT, bregionlist, ...
    ...
    % ============== GET FOR WN
    frsmall_WN = lt_neural_POPLEARN_SylLocked_Over_sub2(neurlist, DAT, bregionlist, ...
        segglobal, xtoplot, plotraw, PARAMS, inds_WN, chanlist);
    ...
    % ======================= GET LFP DURING WN
    lfpcollect_WN = lt_neural_POPLEARN_SylLocked_Over_sub1(chanlist_lfp, ...
        bregion_lfp, DATLFP, inds_WN, xtoplot, fpass, plotraw);
