...
SylsBad = {...,
    ...
    {'gr48bu5', 'RALMANLearn7', 1, 'jb(h)', 'wn'}, ... % NOTE: gr48-RL7, only removed based on WN, did not check noisy syls
    {'gr48bu5', 'RALMANLearn7', 1, '(a)rd', 'wn'}, ...
    {'gr48bu5', 'RALMANLearn7', 1, '(a)j', 'wn'}, ...
    {'gr48bu5', 'RALMANLearn7', 1, '(r)rd', 'wn'}, ...
    {'gr48bu5', 'RALMANLearn9', 1, '(r)rd)', 'noise'}, ... % NOTE: gr48-RL9, only removed based on WN, did not check noisy syls
    {'gr48bu5', 'RALMANLearn9', 1, '(j)jb', 'wn'}, ...
    {'gr48bu5', 'RALMANLearn9', 1, '(r)d', 'wn'}, ...
    {'gr48bu5', 'RALMANLearn9', 1, 'ab(h)', 'wn'}, ...
    {'gr48bu5', 'RALMANLearn9', 1, '(a)rd', 'wn'}, ...
    {'gr48bu5', 'RALMANLearn9', 1, '(a)j', 'wn'}, ...
    };
