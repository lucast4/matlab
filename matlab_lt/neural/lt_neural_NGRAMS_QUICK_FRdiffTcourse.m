function [FRdiffDAT, FRdiffShuff, FRdiff_Z, Nboth, FRmat, TrialInds] = ...
    lt_neural_NGRAMS_QUICK_FRdiffTcourse(frmat1, frmat2, downfactor, ...
    nshufftmp, Params)
%% LT 5/22/18 - modified from lt_neural_NGRAMS_QUICK_FRdiff to do timecours
% i.e. previously was one value, averaged within a bin. now is over all
% window.
...
FRdiff_Z = (FRdiffDAT - mean(FRdiffShuff,2))./std(FRdiffShuff, 0 ,2);
