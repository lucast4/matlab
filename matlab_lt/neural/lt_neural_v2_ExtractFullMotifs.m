...
MotifsToCollect = {'pu69wh78', {'(j)jbhhg', '(a)abhhg'}, ...
    'wh44wh39', {'(n)hh', '(d)kccbb'}, ...
    'gr48bu5', {'(a)jjbh', '(a)rdabh', '(r)rr'}, ...
    'wh72pk12', {'(j)rbhga', '(j)klbhga', '(j)iobhga' '(m)kd'}};
% MotifsToCollect = {'pu69wh78', {'(j)bhh', 'j(b)hh', '(a)bhh', 'a(b)hh'}, ...
%     'wh44wh39', {'(n)hh', '(d)k', '(c)cbb'}, ...
%     'gr48bu5', {'(a)jjbh', '(a)rdabh', '(r)rr'}, ...
%     'wh72pk12', {'(j)rbhga', '(j)klbhga', '(j)iobhga' '(m)kd'}}; % these versions limit the distortion caused
