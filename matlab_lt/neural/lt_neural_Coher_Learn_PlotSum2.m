...
if strcmp(fieldtoplot, 'spec')
    ...
    [fignums_alreadyused, hfigs, figcount, hsplot]=lt_plot_MultSubplotsFigs('', subplotrows, subplotcols, fignums_alreadyused, hfigs, figcount);
    lt_neural_Coher_Plot(dat1_wn, tbins, ffbins, 2, '-', clim+[-1 1], 1, 1);
    title('chan1, WN');
    ylabel(ylabthis);
    axis tight;
    ...
    [fignums_alreadyused, hfigs, figcount, hsplot]=lt_plot_MultSubplotsFigs('', subplotrows, subplotcols, fignums_alreadyused, hfigs, figcount);
    lt_neural_Coher_Plot(dat2_wn, tbins, ffbins, 2, '-', clim+[-1 1], 1, 1);
    title('chan2, WN');
    axis tight;
    ...
    % ------------ PLOT TIMECOURSE IN A FEW FREQUENCY BINS
    [fignums_alreadyused, hfigs, figcount, hsplot]=lt_plot_MultSubplotsFigs('', subplotrows, subplotcols, fignums_alreadyused, hfigs, figcount);
    lt_neural_Coher_Plot(dat1, tbins, ffbins, 2, '-', clim+[-1 1], 1, 1);
    title('chan1');
    axis tight;
    ...
    [fignums_alreadyused, hfigs, figcount, hsplot]=lt_plot_MultSubplotsFigs('', subplotrows, subplotcols, fignums_alreadyused, hfigs, figcount);
    lt_neural_Coher_Plot(dat2, tbins, ffbins, 2, '-', clim+[-1 1], 1, 1);
    title('chan2');
    axis tight;
    ...
    [fignums_alreadyused, hfigs, figcount, hsplot]=lt_plot_MultSubplotsFigs('', subplotrows, subplotcols, fignums_alreadyused, hfigs, figcount);
    lt_neural_Coher_Plot(dat3, tbins, ffbins, 2, '-', clim+[-1 1], 1, 1);
