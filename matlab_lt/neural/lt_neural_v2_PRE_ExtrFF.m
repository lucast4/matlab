...
% -------------------
FFparamsAll.bird(7).birdname = 'wh44wh39';
...
%     [0.023 0.028]};
FFparamsAll.bird(8).FFparams.cell_of_FFtimebins={'b', [0.028 0.033], 'h', [0.035 0.043], 'g', ...
    [0.049 0.068], 'a', [0.052 0.056], 'k', [0.03 0.038], 'l', [0.024 0.028], 'd', ...
    [0.023 0.028]}; % here reduced time for "a" because fo learning.
FFparamsAll.bird(8).FFparams.cell_of_FFtimebins_DurLearn=FFparamsAll.bird(8).FFparams.cell_of_FFtimebins;


% -------------------
indthis = 9;
FFparamsAll.bird(indthis).birdname = 'gr48bu5';
FFparamsAll.bird(indthis).FFparams.cell_of_freqwinds={'b', [2800 3850], ...
    'h', [2950 4000], 'a', [1000 2250], 'd', [1300 2450]};
FFparamsAll.bird(indthis).FFparams.cell_of_FFtimebins={'b', [0.042 0.0475], ...
    'h', [0.025 0.028], 'a', [0.079 0.086], 'd', [0.039 0.051]};
FFparamsAll.bird(indthis).FFparams.cell_of_FFtimebins_DurLearn=FFparamsAll.bird(indthis).FFparams.cell_of_FFtimebins;
