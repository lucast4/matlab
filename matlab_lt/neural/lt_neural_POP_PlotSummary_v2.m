function OUTSTRUCT = lt_neural_POP_PlotSummary_v2(MOTIFSTATS_pop, SummaryStruct, plotRaw, ...
    birdstoplot)
%% lt 1/21/19 - modified from v1 to not assert that all motif names have to be identical across neurons 
% across all experiments for a bird. 
...
%     for ii=1
        ...
        for iii=1:numsets
            ...
            for mm = 1:nummotifs
                ...
                % --- what is global motifID?
                motifID = lt_neural_QUICK_MotifID(bname, motifstr);
                ...
                for nn=1:nneur
                    for nnn=nn+1:nneur
                        ...
                        OUTSTRUCT.Pairs.motifID_glob= [OUTSTRUCT.Pairs.motifID_glob; motifID];
